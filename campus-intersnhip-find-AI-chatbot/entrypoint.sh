...
# ----------------------------------------------------------------------------
# 2. Start Ollama Model Service (if installed)
...
if command -v ollama >/dev/null 2>&1; then
  ...
  echo "WARNING: Ollama not found. Backend may fail to connect."
fi

# ----------------------------------------------------------------------------
# 3. Start Backend (Uvicorn/FastAPI)
echo "[3/5] Starting backend navigator..."
...
echo "[4/5] Testing backend connectivity..."
...
# ----------------------------------------------------------------------------
# 5. Start Streamlit (the main web UI)
